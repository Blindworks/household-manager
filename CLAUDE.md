...
- In der Kachelüberschrift steht die Messgröße groß, der Sensorname klein daneben und rechts der jüngste Wert; **nur beim IAQ** wird er nach `iaqLevel` eingefärbt — für Feinstaub, VOC und CO gibt es hier bewusst keine Bewertung, das wäre eine eigene Entscheidung über den anzuwendenden Grenzwert
