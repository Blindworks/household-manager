...
- Die sechs Bestandskategorien wurden mit genau den Schlüsseln geseedet, die der Scheduler vorher als State schrieb (`general`, `family`, `health`, `household`, `work`, `birthday`) — bestehende Flows haben die Umstellung nicht bemerkt
