...
- [kasa-bulb-support.md](kasa-bulb-support.md) - legacy Kasa (KL110) Leuchtmittel; is_dimmable/is_color/is_variable_color_temp explizite Flags statt Feld-Praesenz; bulb-Flag aus Metadata statt Re-Probe vor jedem Toggle; LightState/applyCurrentLightState mit Tapo geteilt
