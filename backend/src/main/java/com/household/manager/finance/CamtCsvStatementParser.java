...
public class CamtCsvStatementParser implements StatementParser {
    ...
    private ParsedStatement buildStatement(CSVParser csvParser) throws IOException {
        ...
        for (CSVRecord record : csvParser) {
            ...
            if (bookingDate == null) {
                log.warn("Skipping CSV row {} — Buchungstag is empty or unparseable",
            ...
            ParsedTransaction tx = ParsedTransaction.builder()
                    ...
                    .valueDate(parseGermanDate(value(record, "Valutadatum")))
    ...
    /**
     * Parses a date in {@code dd.MM.yy} format (e.g. {@code 24.06.26}).
     *
